        ...
        this.attributes = new Proxy([], {
            set: (obj, name, value) => {
                ...
                if (attribute != undefined) {
                    ...
                    program.attributeBuffer[program.currentStack].push(new Attrubute(this.gl, program.program, type, name, value));
                }
                return true;
            },
            get: (obj, name) => {
        ...
        this.uniforms = new Proxy([], {
            set: (obj, name, value) => {
                ...
                if (uniform != undefined) {
                    ...
                    program.uniformBuffer.push(new Uniform(this.gl, program.program, type, name, value));
                }
                return true;
            },
            get: (obj, name) => {
...
export class Shader {
    ...
    compile() {
        if (this.shader != null && !this._changed)
            return;
        if (this.gl == null) {
            throw new Error("Shader is not attached!");
        }
