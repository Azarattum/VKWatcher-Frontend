...
export default class Session {
     ...
     */
    constructor(from: Date | number, to: Date | number = from, platform: Platforms = Platforms.unknown) {
     ...
     */
    isCovered(date: Date | number, dailyPrecision: boolean = true) {
