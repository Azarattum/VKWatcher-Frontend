...
export default class Chart {
     ...
     */
    async switch(user: User): Promise<void> {
    ...
    refresh(): void {
        ...
        this.chart.drawer.onrecalculated = () => {
            ...
            const values = (this.chart.elements as { values: HTMLElement }).values.children;
    ...
    update(): void {
        ...
        if (this.chart.controller) {
            ...
            (this.chart.controller.selector as HTMLElement)
     ...
     */
    private async convertData(user: User) {
        //Device colors
